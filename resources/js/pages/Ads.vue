...
onMounted(() => {
  const params = getAdQueryParams()
  store.loadAds(params.page, params.sortBy, params.order)
})
</script>
...
<template>
  ...
  <div v-if="store.error"
    ...
    <div class="bg-base-300 rounded-lg border border-neutral flex">
      <h1 class="p-4 text-center text-3xl">{{ store.error }}</h1>
      <div class="w-16 border-l border-neutral hover:bg-neutral cursor-pointer duration-300"
